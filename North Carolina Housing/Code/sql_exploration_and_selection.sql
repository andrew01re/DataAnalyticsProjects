--Before using SQL, the Original Data files were uploaded into a BigQuery Database
--BigQuery was used to first explore the data and then create the initial table views that will be cleaned in RStudio before uploading to Tableau

---------------------Housing metrics------------------------
--These tables will be used to create the initial dashboard page that shows the median home price (zhvi zillow data) and other housing metrics
...
-------The rest of these tables will be used to create county profile pages showing demographic and lifestyle data for the selected county
----------------------Commute as of 2019-------------------------
